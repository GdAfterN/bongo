...
ASK_HELP = textwrap.dedent(
    ...
    1. 信任路径（文件操作）
       ...
       适合：阅读课程资料、整理文档、提炼知识点。
       示例：/ask 帮我总结这份操作系统讲义的核心概念
...
def build_arg_parser():
    ...
    parser = argparse.ArgumentParser(
        ...
        description="Local AI learning agent for notes, practice, knowledge review, and trusted-document assistance.",
    )
